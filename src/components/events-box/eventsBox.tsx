...
import SommerCupLogo from "./../../assets/images/logos/sommer-cup-logo.svg";
import WinterCupLogo from "./../../assets/images/logos/winter-cup-logo.svg";
import UniLigaLogo from "./../../assets/images/logos/uni-liga-logo.svg";
import GoldenSportsLogo from "./../../assets/images/logos/golden-sports-logo.svg";
import KleinfeldLogo from "./../../assets/images/logos/kleinfeld-logo.svg";

import EventBoxItem from "./../event-box-item/eventBoxItemt";


const EventsList = [
  { id: 1, text: "Sommer Cup", logo: SommerCupLogo, link: "https://sommercup.goldensports.at/" },
  { id: 2, text: "Winter Cup", logo: WinterCupLogo, link: "/" },
  { id: 3, text: "Kleinfeld", logo: KleinfeldLogo, link: "https://kleinfeldwm.goldensports.at/" },
  { id: 4, text: "Beasiness League", logo: GoldenSportsLogo, link: "/" },
  { id: 5, text: "Uni Liga", logo: UniLigaLogo, link: "https://uniliga.at/" },
];

const EventsBox = () => {
  const [openListEvents, setOpenListEvents] = useState(false);
    ...
    <>
      ...
      >
        ...
        <div className={classes.list} ref={list_events}>
          {EventsList.map((item) => (
            <EventBoxItem key={item.id} info={item} activeClass={openListEvents} />
          ))}
        </div>
      </div>
    </>
